...
const navMenu = [
  ...
  { href: "/projects", label: "Daily Update" },
];
        ...
        <SheetContent side="right" className="bg-red-50">
          ...
          <div className="px-10 space-y-4" style={{ fontFamily: "satoshi-medium" }}>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-zinc-700">muhammadrafiariza@gmail.com</span>
            </div>
          
            {/* Phone */}
            <div className="flex items-center gap-3">
              <MdPhone className="text-rose-500" size={20} />
              <span className="text-zinc-700">+60 17-454-1951</span>
            </div>
          
            {/* Location */}
            <div className="flex items-center gap-3">
              <MdLocationOn className="text-rose-500" size={20} />
              <span className="text-zinc-700">Takengon, Aceh Tengah </span>
            </div>
            ...
            <div className="pt-4 mt-20 border-t border-rose-200">
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="https://github.com/rafiariza"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-full bg-white shadow hover:bg-rose-100 transition-colors"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/muhammadrafiariza/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-full bg-white shadow hover:bg-rose-100 transition-colors"
                >
                ...
                <a 
                  href="https://www.instagram.com/rafiarizaa/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-full bg-white shadow hover:bg-rose-100 transition-colors"
                >
