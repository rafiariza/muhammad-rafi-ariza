...
import myImg from '../assets/fotodepan.jpg';
  ...
  return (
    <section className="min-h-screen flex flex-col -mt-10 md:flex-row items-center justify-center px-8 py-16 bg-white">
      ...
      >
        ...
        >
          Hi! I'm <span className="font-semibold text-stone-800">Muhammad Rafi Ariza</span>, 
          an aspiring Front and Backend developer passionate about crafting clean, 
